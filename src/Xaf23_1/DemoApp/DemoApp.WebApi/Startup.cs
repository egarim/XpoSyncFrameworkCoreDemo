...
public class Startup {
    ...
    public const string ServerDeltaStoreCnx = "Integrated Security=SSPI;Pooling=false;Data Source=(localdb)\\mssqllocaldb;Initial Catalog=DemoSyncServer";
    public static string ServerNodeId = "Server";
    #endregion
    ...
    public void ConfigureServices(IServiceCollection services) {
        ...
        services.AddXafWebApi(builder => {
            ...
            builder.Modules
                .AddValidation()
                .Add<DemoApp.Module.DemoAppModule>();
            ...
            builder.AddBuildStep(application => {
                application.ApplicationName = "SetupApplication.DemoApp";
        ...
        services.AddSwaggerGen(c => {
            ...
            c.SwaggerDoc("v1", new OpenApiInfo {
                Title = "DemoApp API",
                Version = "v1",
                Description = @"Use AddXafWebApi(options) in the DemoApp.WebApi\Startup.cs file to make Business Objects available in the Web API."
            });
        ...
        //Clear server before starting
        //DatabaseHelper.DropMSSqlServerDatabase(TestStartup.ServerDeltaStoreCnx, "SyncServer");

        //HACK or you can use the extension method AddSyncServerWithNodes
        services.AddSyncServerWithDeltaStoreNode(SyncFrameworkXpoDefault.GetXpoDeltaStore(ServerDeltaStoreCnx), ServerNodeId);
        //services.AddSyncServerWithDeltaStoreNode(GetDeltaStore(ServerDeltaStoreCnx), "Company 1");
        //services.AddSyncServerWithDeltaStoreNode(GetDeltaStore(ServerDeltaStoreCnx), "Company 2");
    }
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env) {
        if(env.IsDevelopment()) {
            ...
            app.UseSwagger();
            app.UseSwaggerUI(c => {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "DemoApp WebApi v1");
            });
        }
        else {
